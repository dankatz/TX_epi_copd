...
op2018 <- left_join(op2018_full, op2018enc) %>% mutate(SOURCE_OF_ADMISSION = as.character(SOURCE_OF_ADMISSION))
op2019 <- left_join(op2019_full, op2019enc) %>% mutate(SOURCE_OF_ADMISSION = as.character(SOURCE_OF_ADMISSION))
op2020 <- left_join(op2020_full, op2020enc) %>% mutate(SOURCE_OF_ADMISSION = as.character(SOURCE_OF_ADMISSION))
...
# there are 1074 cases that are Black and Latinx
